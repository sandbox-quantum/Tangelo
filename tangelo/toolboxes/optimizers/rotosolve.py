...
def extrapolate_expval(theta, m_0, m_minus, m_plus, phi=0.0):
    ...
    RX, RY, RZ) with angle theta. The extrapolation is
    computed based on samples taken at the angles
    phi, phi+pi/2, and phi-pi/2. This function used the
    formula in Appendix A from arXiv:1905.09692, by
