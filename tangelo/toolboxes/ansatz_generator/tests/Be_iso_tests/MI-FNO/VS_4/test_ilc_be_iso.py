...
# Instantiate QMF ansatz -- note that SCBK mapping doesn't work for VS = 4 in Tangelo
...
qmf.set_var_params([np.pi, np.pi, np.pi, 0., np.pi, np.pi, np.pi, 0., 0., 0., 0., 0., 0., 0., 0., 0.])
qmf.build_circuit()
