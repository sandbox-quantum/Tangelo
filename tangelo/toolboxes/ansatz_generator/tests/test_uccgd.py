...
class UCCGDTest(unittest.TestCase):
    ...
    def test_uccgd_set_var_params(self):
        ...
        np.testing.assert_array_almost_equal(uccgd_ansatz.var_params, five_ones, decimal=6)

        uccgd_ansatz.set_var_params([1., 1., 1., 1., 1.])
        np.testing.assert_array_almost_equal(uccgd_ansatz.var_params, five_ones, decimal=6)

        uccgd_ansatz.set_var_params(np.array([1., 1., 1., 1., 1.]))
        np.testing.assert_array_almost_equal(uccgd_ansatz.var_params, five_ones, decimal=6)
    ...
    def test_uccgd_H2(self):
        ...
        sim = Simulator()
        uccgd_ansatz.update_var_params([1., 0.78525105, 1.14993361, 1.57070471, 1.])
    ...
    def test_uccgd_H4_open(self):
        ...
        var_params = [1.00000000, 0.79092606, 0.47506062, 0.80546313, 0.88827205,
                      1.35659603, 0.85509053, 0.86380802, 0.89392798, 0.71922788,
                      1.36597650, 1.41426772, 0.96502797, 0.90349484, 0.58184862,
                      0.91536039, 0.64726991, 0.78419327, 1.59344719, 0.88236760,
                      1.00000000, 1.26174588, 0.78342616, 1.21796644, 1.21234109,
                      0.29929539, 1.53074675, 1.41872463, 0.85843055, 1.10503577,
                      1.00000000, 1.19597016, 0.92342705, 1.02231599, 1.00000000]
