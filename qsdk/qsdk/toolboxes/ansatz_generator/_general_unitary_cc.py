...
def get_number_operator_penalty(n_orbs, n_electrons, mu=1, up_then_down=False):
    """Function to generator the normal ordered number opeator penalty term as a FermionicOperator
...
def get_spin_operator_penalty(n_orbs, sz, mu=1, up_then_down=False):
    """Function to generator the normal ordered Sz opeator penalty term
...
def get_spin2_operator_penalty(n_orbs, s2, mu=1, up_then_down=False):
    """Function to generator the normal ordered S^2 opeator penalty term
