...
class HEATest(unittest.TestCase):
    ...
    def test_hea_set_var_params(self):
        ...
        hea_ansatz.set_var_params(np.zeros(4 * 3 * 3))
    ...
    def test_hea_H2(self):
        ...
        params = [1.96262489e+00,  4.72852133e+00,  4.46356300e+00, -9.83505909e-01,
                  4.50012102e+00, -3.14524440e+00, -1.92659543e+00,  4.71213972e+00,
                  4.71239665e+00,  3.68638855e+00, -4.72825044e+00,  1.79676072e+00,
                  4.16741524e+00,  6.39944906e+00, -2.94623607e+00, -3.06056499e+00,
                 -1.44020337e+00,  3.15592219e+00, -2.70616213e+00, -6.33177816e+00,
                 -5.14396016e+00, -2.05962953e+00,  3.14216799e+00,  1.08194211e+00,
                  6.25913105e-01,  1.55418991e+00, -2.32267456e+00, -7.62290954e-02,
                 -3.14115924e+00,  3.26312961e+00,  3.52590185e-03,  4.69079147e+00,
                 -2.72130709e+00, -1.57161049e+00,  1.57141235e+00, -1.55068880e+00]
    ...
    def test_hea_H4(self):
        ...
        uccsd_ansatz = HEA(molecule, rottype='real')
