...
def generalized_singles_list(n_orbs, up_then_down=False):
    r"""Function to generator the generalized singles generator
...
def paired_doubles_list(n_orbs, up_then_down=False):
    r"""Function to generator the generalized paired doubles generator
    ...
    Returns:
        all_terms (list): The generalized singles term \sum_{ij} t_{ij} a_i^+ a_j"""
