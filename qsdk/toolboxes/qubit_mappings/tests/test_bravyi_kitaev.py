...
class BravyiKitaevTest(unittest.TestCase):
    ...
    def test_openfermion_equivalence(self):
        ...
        self.assertEqual(len(qsdk_result.terms),
                         len(openfermion_result.terms),
                         msg="Number of terms generated does not agree with openfermion implementation of Bravyi Kitaev.")
