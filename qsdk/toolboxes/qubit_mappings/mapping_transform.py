...
def fermion_to_qubit_mapping(fermion_operator, mapping, n_qubits=None, n_electrons=None, up_then_down=False):
    ...
    if up_then_down:
        ...
        fermion_operator = make_up_then_down(fermion_operator, n_modes=n_qubits)
...
def make_up_then_down(fermion_operator, n_modes):
