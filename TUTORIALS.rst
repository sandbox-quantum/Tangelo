...
* `VQE<https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/vqe.ipynbb>`_
* `ADAPT-VQE <https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/adapt.ipynb>`_
* `Custom VQE <https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/vqe_custom_ansatz_hamiltonian.ipynb>`_
* `DMET <https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/dmet.ipynb>`_
* `ONIOM  <https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/oniom.ipynb>`_
* `Classical Shadows <https://github.com/AlexandreF-1qbit/Tangelo/blob/develop/examples/classical_shadows.ipynb>`_
